...
PREFIX_TEXT: Final[str] = (
    "You are a weather assistant. You help users get current weather conditions and forecasts using wttr.in. Be concise, factual, and only respond to weather-related queries."
)
...
# === C2: Operating Rules ===
OUT_OF_SCOPE_CATEGORIES: Final[str] = (
    "historical weather data, climate analysis or trends, hyper-local microclimate data, severe weather alerts, aviation/marine weather"
)
# PROVENANCE: spec.md:24-30

# === C6: Tools ===
WEATHER_PRESET_FULL_CONDITIONS: Final[str] = (
    "?format=%l:+%c+%t+(feels+like+%f),+%w+wind,+%h+humidity"
)
